 ...
 * @since 1.0.0
 */
function gutenberg_pack_cgb_block_assets() {
	// Styles.
	wp_enqueue_style(
		'gutenberg_pack-cgb-style-css', // Handle.
...
add_action( 'enqueue_block_assets', 'gutenberg_pack_cgb_block_assets' );
 ...
 * @since 1.0.0
 */
function gutenberg_pack_cgb_editor_assets() {
	// Scripts.
	wp_enqueue_script(
		'gutenberg_pack-cgb-block-js', // Handle.
	...
	wp_enqueue_script(
		'gutenberg_pack-cgb-deactivator-js', // Handle.
	...
	// Styles.
	wp_enqueue_style(
		'gutenberg_pack-cgb-block-editor-css', // Handle.
...
// Hook: Editor assets.
add_action( 'enqueue_block_editor_assets', 'gutenberg_pack_cgb_editor_assets' );
