...
registerBlockType('gutenbergpack/star-rating', {
	...
	attributes: {
		...
		reviewText: {
			type: 'array',
			source: 'children',
			selector: '.gutenbergpack-review-text'
		}
	},
	...
	edit: withState({ editable: 'content' })(function(props) {
		...
		return [
			...
			<div className="gutenbergpack-star-rating">
				<div className="gutenbergpack-star-container">
				...
				<div key={'editable'} className="gutenbergpack-review-text">
					<RichText
						tagName="div"
	...
	save(props) {
		...
		return (
			<div className="gutenbergpack-star-rating">
				...
				<div className="gutenbergpack-review-text">{reviewText}</div>
			</div>
		);
	}
});
