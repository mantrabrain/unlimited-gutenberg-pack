...
class TableOfContents extends Component {
	...
	render() {
		...
		if (this.state.headers) {
			return (
				<div className="gutenbergpack_table-of-contents-container">
			...
			return (
				this.props.blockProp && (
					<p className="gutenbergpack_table-of-contents-placeholder">
						{__(
...
registerBlockType('gutenbergpack/table-of-contents', {
	title: __('Table of Contents'),
	icon: icon,
	category: 'gutenbergpack',
	keywords: [__('Table of Contents'), __('Gutenberg Pack')],

	attributes: {
		title: {
			type: 'array',
			source: 'children',
			selector: '.gutenbergpack_table-of-contents-title'
		},
		links: {
			type: 'string',
			default: ''
	...
	edit: withState({ editable: 'content' })(function(props) {
		...
		return (
			<div className="gutenbergpack_table-of-contents">
				<div className="gutenbergpack_table-of-contents-header">
					<div className="gutenbergpack_table-of-contents-title">
						<RichText
							placeholder={__('Optional title')}
							className="gutenbergpack_table-of-contents-title"
