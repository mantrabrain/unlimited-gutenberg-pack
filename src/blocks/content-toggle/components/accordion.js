...
export default class Accordion extends Component {
	render() {
		...
		return <div className="wp-block-gutenbergpack-content-toggle-accordion" style={ { borderColor: attributes.theme } } key={ i }>
			<div className="wp-block-gutenbergpack-content-toggle-accordion-title-wrap" style={ { backgroundColor: attributes.theme } }>
				<RichText
					tagName="span"
					style={{
				...
				/>
				<span onClick={ () => { toggleAccordionState( i ) } } className={ 'wp-block-gutenbergpack-content-toggle-accordion-state-indicator dashicons dashicons-arrow-right-alt2 ' + ( accordionsState[ i ] ? 'open' : '' ) }></span>
			</div>
			{ accordionsState[ i ] &&
			<div className="wp-block-gutenbergpack-content-toggle-accordion-content-wrap">
				<RichText
					tagName="div"
					className="wp-block-gutenbergpack-content-toggle-accordion-content"
			...
			<div className="wp-block-gutenbergpack-content-toggle-accordion-controls-top">
			...
			<div className="wp-block-gutenbergpack-content-toggle-accordion-controls-bottom">
