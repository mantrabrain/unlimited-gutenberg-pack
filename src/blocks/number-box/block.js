 ...
 */
registerBlockType('gutenbergpack/number-box', {
    ...
    attributes: {
        ...
        columnOneNumber: {
            type: 'array',
            source: 'children',
            selector: '.gutenbergpack_number_one_number'
        },
        columnTwoNumber: {
            type: 'array',
            source: 'children',
            selector: '.gutenbergpack_number_two_number'
        },
        columnThreeNumber: {
            type: 'array',
            source: 'children',
            selector: '.gutenbergpack_number_three_number'
        },
        columnOneTitle: {
            type: 'array',
            source: 'children',
            selector: '.gutenbergpack_number_one_title'
        },
        columnTwoTitle: {
            type: 'array',
            source: 'children',
            selector: '.gutenbergpack_number_two_title'
        },
        columnThreeTitle: {
            type: 'array',
            source: 'children',
            selector: '.gutenbergpack_number_three_title'
        },
        columnOneBody: {
            type: 'array',
            source: 'children',
            selector: '.gutenbergpack_number_one_body'
        },
        columnTwoBody: {
            type: 'array',
            source: 'children',
            selector: '.gutenbergpack_number_two_body'
        },
        columnThreeBody: {
            type: 'array',
            source: 'children',
            selector: '.gutenbergpack_number_three_body'
        },
        numberBackground: {
            type: 'string',
            default: '#CCCCCC'
    ...
    edit: withState({ editable: 'content' })(function (props) {
        ...
        return [
            ...
            <div key={'editable'} className={props.className}>
                <div className={`gutenbergpack_number_box column_${column}`}>
                    <div
                        className="gutenbergpack_number_1"
                        style={{
                            borderColor: borderColor
                        }}
                    >
                        <div
                            className="gutenbergpack_number_box_number"
                            style={{
                        ...
                        >
                            <RichText
                                tagName="p"
                                placeholder={__('1')}
                                className="gutenbergpack_number_one_number"
                                style={{
                                    color: numberColor
                                }}
                        ...
                        <RichText
                            ...
                            className="gutenbergpack_number_one_title"
                        ...
                        <RichText
                            ...
                            className="gutenbergpack_number_one_body"
                            value={columnOneBody}
                    ...
                    <div
                        className="gutenbergpack_number_2"
                        style={{
                            borderColor: borderColor
                        }}
                    >
                        ...
                        >
                            <RichText
                                tagName="p"
                                placeholder={__('2')}
                                className="gutenbergpack_number_two_number"
                                style={{
                                    color: numberColor
                                }}
                        ...
                        <RichText
                            ...
                            className="gutenbergpack_number_two_title"
                        ...
                        <RichText
                            tagName="p"
                            placeholder={__('Your content goes here.')}
                            className="gutenbergpack_number_two_body"
                            value={columnTwoBody}
                    ...
                    <div
                        className="gutenbergpack_number_3"
                        style={{
                            borderColor: borderColor
                        }}
                    >
                        ...
                        >
                            <RichText
                                tagName="p"
                                placeholder={__('3')}
                                className="gutenbergpack_number_three_number"
                                style={{
                                    color: numberColor
                                }}
                        ...
                        <RichText
                            ...
                            className="gutenbergpack_number_three_title"
                        ...
                        <RichText
                            tagName="p"
                            placeholder={__('Your content goes here.')}
                            className="gutenbergpack_number_three_body"
            ...
            <div className={props.className}>
                <div className={`gutenbergpack_number_box column_${column}`}>
                    ...
                    >
                        ...
                        <p className="gutenbergpack_number_one_title">{columnOneTitle}</p>
                        <p className="gutenbergpack_number_one_body">{columnOneBody}</p>
                    </div>
                    <div
                        className="gutenbergpack_number_2"
                        style={{
                    ...
                    >
                        ...
                        <p className="gutenbergpack_number_two_title">{columnTwoTitle}</p>
                        <p className="gutenbergpack_number_two_body">{columnTwoBody}</p>
                    </div>
                    <div
                        className="gutenbergpack_number_3"
                        style={{
                    ...
                    >
                        ...
                        <p className="gutenbergpack_number_three_title">{columnThreeTitle}</p>
                        <p className="gutenbergpack_number_three_body">{columnThreeBody}</p>
                    </div>
                </div>
            </div>
        );
