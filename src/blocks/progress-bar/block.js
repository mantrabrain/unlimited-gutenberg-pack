...
registerBlockType('gutenbergpack/progress-bar', {
	title: __('Progress Bar'),
	icon: icon,
	category: 'gutenbergpack',
	keywords: [__('Progress Bar'), __('Gutenberg Pack')],
	...
	edit: withState({ editable: 'content' })(function(props) {
		...
		return [
			...
			<div className="gutenbergpack_progress-bar">
				<div key={'editable'} className="gutenbergpack_progress-bar-text">
					<RichText
						tagName="p"
