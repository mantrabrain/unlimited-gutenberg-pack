 ...
 */
registerBlockType('gutenbergpack/social-share', {
	...
	edit: function (props) {
		...
		return [
			...
			<div id="gutenbergpack-social-share-block-editor" className={props.className} key="block-editor">
				<div className={'social-share-icons ' + 'align-icons-' + props.attributes.align}>
					{props.attributes.showFacebookIcon && <a
						href="#gutenbergpack-social-share-block-editor"
