 ...
 */
function gutenbergpack_render_block( $attributes ) {
	...
	return '<div id="gutenbergpack-social-share-block-editor" class="wp-block-gutenbergpack-social-share">
 ...
 * @return void
 */
function gutenbergpack_register_block() {
	if( function_exists( 'register_block_type' ) ) {
		register_block_type( 'gutenbergpack/social-share', array(
			'attributes'      => array(
				// Facebook.
			...
			'render_callback' => 'gutenbergpack_render_block',
		) );
	}
}


add_action( 'init', 'gutenbergpack_register_block' );
